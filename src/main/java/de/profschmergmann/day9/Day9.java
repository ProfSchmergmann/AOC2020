package de.profschmergmann.day9;
...
public class Day9 extends Day {
    ...
    public Day9() {
        super(9);
        this.numbers = this.input.stream().mapToLong(Long::parseLong).boxed().collect(Collectors.toList());
    ...
    public String resultPartTwo() {
        return String.valueOf(this.checkForEncryptionWeakness(
                this.checkForWeakness(this.lengthOfPreamble, this.numbers),
                this.numbers));
    }
